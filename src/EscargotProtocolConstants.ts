...
export enum CLIENT {
  ...
  // These four must be in the same order.
  ESCARGOT_DEBUGGER_EVAL_WITHOUT_STOP_8BIT_START = 10,
  ESCARGOT_DEBUGGER_EVAL_WITHOUT_STOP_8BIT = 11,
  ESCARGOT_DEBUGGER_EVAL_WITHOUT_STOP_16BIT_START = 12,
  ESCARGOT_DEBUGGER_EVAL_WITHOUT_STOP_16BIT = 13,
  ESCARGOT_DEBUGGER_GET_BACKTRACE = 14,
  ESCARGOT_DEBUGGER_GET_SCOPE_CHAIN = 15,
  ESCARGOT_DEBUGGER_GET_SCOPE_VARIABLES = 16,
  ESCARGOT_DEBUGGER_GET_OBJECT = 17,
  // These four must be in the same order.
