...
export enum SERVER {
  ...
  // These four must be in the same order.
  ESCARGOT_DEBUGGER_WATCH_RESULT_8BIT = 30,
  ESCARGOT_DEBUGGER_WATCH_RESULT_8BIT_END = 31,
  ESCARGOT_DEBUGGER_WATCH_RESULT_16BIT = 32,
  ESCARGOT_DEBUGGER_WATCH_RESULT_16BIT_END = 33,
  ESCARGOT_DEBUGGER_BACKTRACE_TOTAL = 34,
  ESCARGOT_DEBUGGER_BACKTRACE = 35,
  ESCARGOT_DEBUGGER_BACKTRACE_END = 36,
  ESCARGOT_DEBUGGER_SCOPE_CHAIN = 37,
  ESCARGOT_DEBUGGER_SCOPE_CHAIN_END = 38,
  // These four must be in the same order.
  ESCARGOT_DEBUGGER_STRING_8BIT = 39,
  ESCARGOT_DEBUGGER_STRING_8BIT_END = 40,
  ESCARGOT_DEBUGGER_STRING_16BIT = 41,
  ESCARGOT_DEBUGGER_STRING_16BIT_END = 42,
  ESCARGOT_DEBUGGER_MESSAGE_VARIABLE = 43,
  ESCARGOT_DEBUGGER_MESSAGE_PRINT = 44,
  ESCARGOT_DEBUGGER_MESSAGE_EXCEPTION = 45,
  ESCARGOT_DEBUGGER_MESSAGE_EXCEPTION_BACKTRACE = 46,
...
export enum CLIENT {
  ...
  ESCARGOT_DEBUGGER_RESTART = 6,
  // These four must be in the same order.
  ESCARGOT_DEBUGGER_EVAL_8BIT_START = 7,
  ESCARGOT_DEBUGGER_EVAL_8BIT = 8,
  ESCARGOT_DEBUGGER_EVAL_16BIT_START = 9,
  ESCARGOT_DEBUGGER_EVAL_16BIT = 10,
  // These four must be in the same order.
  ESCARGOT_DEBUGGER_EVAL_WITHOUT_STOP_8BIT_START = 11,
  ESCARGOT_DEBUGGER_EVAL_WITHOUT_STOP_8BIT = 12,
  ESCARGOT_DEBUGGER_EVAL_WITHOUT_STOP_16BIT_START = 13,
  ESCARGOT_DEBUGGER_EVAL_WITHOUT_STOP_16BIT = 14,
  // These four must be in the same order.
  ...
  ESCARGOT_DEBUGGER_GET_BACKTRACE = 19,
  ESCARGOT_DEBUGGER_GET_SCOPE_CHAIN = 20,
  ESCARGOT_DEBUGGER_GET_SCOPE_VARIABLES = 21,
  ESCARGOT_DEBUGGER_GET_OBJECT = 22,
  // These four must be in the same order.
